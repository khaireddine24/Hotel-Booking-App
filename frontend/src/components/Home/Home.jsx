  ...
  return (
    <div className="min-h-screen max-w-screen bg-gray-50 ">
      ...
      <div className="relative h-[600px] overflow-hidden mr-8">
        ...
        <button
          onClick={nextSlide}
          className="absolute right-4 top-1/2 transform -translate-y-1/2 bg-white md:mr-[13%] bg-opacity-50 p-2 rounded-full hover:bg-opacity-75 transition-all"
        >
      ...
      <div className="py-16 bg-gray-50 mr-8 pr-16">
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mr-[8%]">
